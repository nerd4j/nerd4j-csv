 ...
 * a given {@link String} and return a {@link Date}.
 * 
 * @author Nerd4j Team
 */
public final class ParseDate extends CSVFieldProcessor<String,Date>
{
     ...
     */
    public ParseDate( final String datePattern )
    {
        
        super( null, new StringToDate(datePattern), null );
    ...
    public ParseDate( final String datePattern,
                      ...
                      final CSVFieldValidator<Date> postcondition )
    {
        
        super( precondition, new StringToDate(datePattern), postcondition );
