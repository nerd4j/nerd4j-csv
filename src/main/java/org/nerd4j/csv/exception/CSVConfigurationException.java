...
/**
 * Represents an error occurred during initialization
 * due to inconsistent configuration parameters.
 * 
 * @author Nerd4j Team
 */
public class CSVConfigurationException extends CSVException
{
	 ...
	 *            unknown.)
	 */
	public CSVConfigurationException( Throwable cause )
	{
	 ...
	 *            unknown.)
	 */
	public CSVConfigurationException(String message, Throwable cause)
	{
